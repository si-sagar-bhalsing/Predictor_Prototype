package com.si.fanalytics.predictor_core.framework.data.remote.datasource_impl

import com.si.fanalytics.predictor_core.business.data.network.PredictorNetworkDataSource
import com.si.fanalytics.predictor_core.business.data.safeApiCall

import com.si.fanalytics.predictor_core.business.data.ApiResult
import com.si.fanalytics.predictor_core.business.data.toApiResult
...
import com.si.fanalytics.predictor_core.framework.data.mapper.ApplyBoosterEMapper
import com.si.fanalytics.predictor_core.framework.data.mapper.CreateLeagueEMapper
import com.si.fanalytics.predictor_core.framework.data.mapper.FixtureMapper
import com.si.fanalytics.predictor_core.framework.data.mapper.JoinLeagueEMapper
import com.si.fanalytics.predictor_core.framework.data.mapper.SubmitPredictionRequestEMapper
import com.si.fanalytics.predictor_core.framework.data.mapper.UserPredictionsEMapper
import com.si.fanalytics.predictor_core.framework.data.model.leagues.response.LeagueResponse
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.APPLY_BOOSTER
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.CREATE_LEAGUE_URL
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.FIXTURE_URL
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.JOIN_LEAGUE_URL
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.SUBMIT_PREDICTION_URL
import com.si.fanalytics.predictor_core.framework.data.remote.TextConstant.USER_PREDICTIONS_URL
import com.si.fanalytics.predictor_core.framework.data.remote.service.PredictorService
